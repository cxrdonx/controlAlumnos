...
CREATE TABLE `catedraticos` (
  `idCatedraticos` int NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(45) DEFAULT NULL,
  `Apellido` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idCatedraticos`)
...
INSERT INTO `catedraticos` VALUES (1,'Cristopher','Castillo'),(2,'Erick','Leonardo'),(3,'Dago','Escobar'),(4,'Esna ','Rodriguez');
...
-- Dump completed on 2020-05-24 12:21:49
